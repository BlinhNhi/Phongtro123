...
// lấy body từ file json chothuecaho
const dataBody = [
    {
    ...
    try {
        ...
        dataBody.forEach(cate => {
            cate.body.forEach(async (item) => {
                ...
                //split(',').slice(-1)[0] : từ 1 mảng address tính từ dấu , chia ra thành 3 ele . Từ ele lấy cái ele cuối
                ...
                await db.Post.create({
                    ...
                    overviewId,
                    imagesId,
                    // area là 1 object của areas
                    // hàm find giúp tìm ra ob nằm trong khoảng user tìm và lấy ra code của ob đó
                    // areaCode : dataArea.find(area => area.max > currentArea && area.min <= currentArea )?.code,
                    // priceCode : dataPrices.find(price => price.max > currentPrice && price.min <= currentPrice )?.code,
                    areaCode: dataArea.find(area => area.max > currentArea && area.min <= currentArea)?.code,
                    priceCode: dataPrices.find(area => area.max > currentPrice && area.min <= currentPrice)?.code,
                    provinceCode,
                ...
                //findOrCreate tìm k có mới tạo data
